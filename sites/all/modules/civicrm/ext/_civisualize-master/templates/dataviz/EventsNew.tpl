...
<script>
    ...
    var data = {crmSQL file="events_new"};
    var i = {crmAPI entity="OptionValue" option_group_id="15"}; {*todo on 4.4, use the event-type as id * **** I changed from 14 to 15 *}
        ...
        if(!data.is_error){
            ...
            cj(function($) {
                ...
                eventsBar
                    ...
                    .y(d3.scaleLinear()) // doesn't break anything, but still have decimals and not elastic y axis
                ;
